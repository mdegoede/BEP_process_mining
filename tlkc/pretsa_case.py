...
class PRETSAcase:
    ...
    def add(self, root, dict_log: dict):
        """
    ...
    def find_prefix(self, root, prefix: list) -> Tuple[bool, int]:
        """
        Check and return
    ...
    def updateAncestors(self, root,node):
        count = node.counter
        parent = node.parent
    ...
    def get_traces(self, root,dict_cand):
        traces = []
    ...
    def distance(self, root, trace1, trace2):
        mismatch = 0
        i = 0
    ...
    def simplify_without_time_count(self, log, sensitive):
