...
from pm4py_copy.evaluation.replay_fitness.parameters import Parameters
...
def apply_trace(trace, petri_net, initial_marking, final_marking, best_worst, activity_key):
    ...
    get the attributes)
    petri_net: :class:`pm4py_copy.objects.petri.net.PetriNet` the Petri net to use in the alignment
    initial_marking: :class:`pm4py_copy.objects.petri.net.Marking` initial marking in the Petri net
    final_marking: :class:`pm4py_copy.objects.petri.net.Marking` final marking in the Petri net
