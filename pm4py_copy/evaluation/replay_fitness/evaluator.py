...
'''
from pm4py_copy.evaluation.replay_fitness.variants import alignment_based, token_replay
...
@deprecation.deprecated(deprecated_in="2.2.5", removed_in="3.0",
                        ...
                        details="Use the pm4py_copy.algo.evaluation.replay_fitness package")
def apply(log, petri_net, initial_marking, final_marking, parameters=None, variant=None):
    ...
    fitness_eval
        Fitness evaluation
    """
    warnings.warn("Use the pm4py_copy.algo.evaluation.replay_fitness package")
